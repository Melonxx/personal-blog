...
![](http://upload-images.jianshu.io/upload_images/5780538-696b06ed16411396?imageMogr2/auto-orient/strip)
...
![](http://upload-images.jianshu.io/upload_images/5780538-d3793942772ecc2a?imageMogr2/auto-orient/strip)
...
![](http://upload-images.jianshu.io/upload_images/5780538-d051b984368ea08f?imageMogr2/auto-orient/strip)
...
![](http://upload-images.jianshu.io/upload_images/5780538-f26ed6156bac3b87?imageMogr2/auto-orient/strip)

### 5.拿到 `source`

与 `drawer console` 一样，当我要专注于 `Elements` 面板时，有时我也想看源代码，这时就可以在 `drawer` 中选择显示 `Source`。

![](https://upload-images.jianshu.io/upload_images/5780538-3066472dedb1161f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](http://upload-images.jianshu.io/upload_images/5780538-c5147ce4c8f14ba1?imageMogr2/auto-orient/strip)

`DevTools` 的 `coverage` 工具可以跟踪当前加载的 `JS` 和 `CSS` 文件的 `哪些行正在被执行` ，并显示 `未使用字节的百分比` 。

它用 `绿色` 的线条标记 `运行` 和用 `红色` 的线条标记 `未运行` 。 举个例子：

![](http://upload-images.jianshu.io/upload_images/5780538-dad72db11ec819e7?imageMogr2/auto-orient/strip)
...
![](https://upload-images.jianshu.io/upload_images/5780538-70e4c25576ab9655.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

它不仅会使用差异形式的变化（像 `Git` 这样的源控制工具一样）向你展示，同时还可以撤销它们。

举个例子：

![](http://upload-images.jianshu.io/upload_images/5780538-fa72b229d3f2675b?imageMogr2/auto-orient/strip)
